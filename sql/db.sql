...
SELECT DATE_FORMAT(datetime,'%Y-%m-%d') as date, DATE_FORMAT(datetime,'%H') as hour,DATE_FORMAT(datetime,'%i') as min from db_ml.weather;
SELECT DATE_FORMAT(datetime,'%Y-%m-%d %H:%i:%s') from db_ml.weather;