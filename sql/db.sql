...
(
    ...
    status            int(1) comment '约车状态：0-未预约成功，1-预约取消，2-出行成功',
...
# /usr/local/mysql/bin/mysql -u root -p --local-infile db_ml
-- λ mysql -u root -p --local-infile db_ml

load data local infile '/Users/shiyao/OneDrive/DevFiles/machine-learning-project/data/train_July.csv' into table db_ml.train fields terminated by ',' ignore 1 lines;

load data local infile '/Users/shiyao/OneDrive/DevFiles/machine-learning-project/data/weather.csv' into table db_ml.weather fields terminated by ',' ignore 1 lines;
